...
Tekton was originally the build system for the [Knative serverless workload platform]({{< ref "/blog/kubernetes/knative-fundamental-concepts" >}}). It was converted to a standalone project implementing a general-purpose CI/CD platform. It was donated to the Continuous Delivery Foundation in March 2019.
